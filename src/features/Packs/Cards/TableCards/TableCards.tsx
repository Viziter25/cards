        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead sx={{ backgroundColor: '#EFEFEF' }}>
            <TableRow>
              ...
              <TableCell align="center"><SuperSort sort={sort} nameValue={'Answer'} value={'cardAnswer'} onChange={setSort} /></TableCell>
              <TableCell align="center"><SuperSort sort={sort} nameValue={'Last Updated'} value={'updated'} onChange={setSort} /></TableCell>
              <TableCell align="center"><SuperSort sort={sort} nameValue={'Grade'} value={'grade'} onChange={setSort} /></TableCell>
